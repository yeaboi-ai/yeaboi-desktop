// The home's two doors: the word on each, where it opens per world, and which
// screens each door's duck follows the reader into.

import { describe, expect, it } from 'vitest';
import { AUDIENCES } from '../src/shared/audience';
import { DOORS, doorForPath, doorHref, doorWord } from '../src/renderer/lib/yeaboi/home';
