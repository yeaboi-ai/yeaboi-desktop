      ...
      <Sheet open={openSheet === "org"} onOpenChange={(o) => !o && close()}>
        <SheetContent side="right" className="sm:max-w-md">
          <SheetHeader>
            ...
            <SheetDescription>
              Inherit the theme set by your organization admin.
            </SheetDescription>
          </SheetHeader>
          <OrgDefaultPanel
  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto px-5 py-5 space-y-4">
      ...
      <p className="text-[11px] font-body text-muted-foreground/80">
        New members see this theme until they pick their own. You can stop following at any time
        by picking another theme from the grid.
      </p>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="flex gap-1.5">
                    <span className="w-6 h-6 rounded-full border border-black/10" style={{ background: tokens["primary"] }} />
                    <span className="w-6 h-6 rounded-full border border-black/10" style={{ background: tokens["destructive"] }} />
                    <span className="w-6 h-6 rounded-full border border-black/10" style={{ background: tokens["chart-2"] }} />
                    <span className="w-6 h-6 rounded-full border border-black/10" style={{ background: tokens["chart-3"] }} />
                    <span className="w-6 h-6 rounded-full border border-black/10" style={{ background: tokens["chart-4"] }} />
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-wrap items-center gap-2 flex-1">
                        ...
                        {suggestion.logo_url &&
                          editLogoUrl !== suggestion.logo_url && (
                            <button
                              type="button"
