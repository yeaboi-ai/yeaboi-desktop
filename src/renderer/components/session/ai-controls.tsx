...
const PERSONAS = [
  {
    ...
    description: 'Sharp, opinionated, drives decisions',
    icon: '\u{1F6E0}',
  },
  {
    id: 'pm',
    label: 'Product Manager',
    description: 'User-focused, prioritizes features by impact',
    icon: '\u{1F4CB}',
  },
  {
    id: 'architect',
    label: 'System Architect',
    description: 'Deep technical, focuses on scalability and patterns',
    icon: '\u{1F3D7}',
  },
  {
    id: 'mentor',
    label: 'Patient Mentor',
    description: 'Explains concepts, asks teaching questions',
    icon: '\u{1F393}',
  },
  {
    id: 'challenger',
    label: "Devil's Advocate",
    description: 'Questions everything, stress-tests ideas',
    icon: '\u{1F525}',
  },
] as const;
...
const ASSERTIVENESS_LEVELS = [
  {
    ...
    label: 'Passive',
    plainLabel: 'Quiet',
    description: 'Only speaks when asked',
  },
  {
    value: 'balanced',
    label: 'Balanced',
    plainLabel: 'Even',
    description: 'Interjects at natural pauses',
  },
  {
    value: 'active',
    label: 'Active',
    plainLabel: 'Pushy',
    description: 'Guides firmly, keeps pace high',
  },
] as const;
...
export const INVOLVEMENT_LEVELS = [
  {
    value: 'observer',
    label: 'Observer',
    plainLabel: 'Watches quietly',
    description: 'Silent — only speaks when summoned',
  },
  {
    value: 'responsive',
    label: 'Responsive',
    plainLabel: 'Answers when asked',
    description: "Answers when addressed; doesn't interrupt",
  },
  {
    value: 'facilitator',
    label: 'Facilitator',
    plainLabel: 'Helps the meeting',
    description: 'Speaks at natural breaks; balances air-time',
  },
  {
    value: 'driver',
    label: 'Driver',
    plainLabel: 'Leads the meeting',
    description: 'Pushes the agenda on every turn',
  },
] as const;
              ...
              {PERSONAS.map((persona) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] font-medium leading-tight ${active ? 'text-primary' : 'text-foreground'}`}
                    >
                      {persona.label}
                    </span>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] text-muted-foreground/70">
                  {plainLanguage
                    ? '"Helps the meeting" instead of "Facilitator"'
                    : 'Show jargon labels'}
                </p>
              </div>
              <Switch
