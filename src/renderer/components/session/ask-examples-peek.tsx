...
export function AskExamplesPeek({ persona = "default", onPick, variant = "subtle" }: AskExamplesPeekProps) {
          ...
          {prompts.map((p) => (
            <li key={p}>
              {onPick ? (
                ...
                <div className="text-[12px] text-muted-foreground px-2 py-1.5">&ldquo;{p}&rdquo;</div>
              )}
            </li>
          ))}
        </ul>
