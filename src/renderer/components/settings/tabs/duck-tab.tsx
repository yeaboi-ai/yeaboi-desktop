...
export function DuckTab() {
  ...
  return (
    // Two columns packed by hand: a grid row is as tall as its tallest cell,
    // so the short card sat beside the tall one with a hole under it.
    <div className="grid items-start gap-4 xl:grid-cols-2" aria-busy={loading}>
        ...
        <SettingsCard index={3}>
          ...
          <div className="py-2">
            <Row
              ...
              hint="The only one that reaches you with yeaboi closed"
            >
              <Switch
            ...
            <Row
              title="The duck says it"
              hint="A bubble on the desktop; click it to open the result"
            >
              <Switch
