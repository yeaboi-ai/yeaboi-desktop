...
function NodeHoverMenuComponent({
  ...
  return (
    ...
    >
      ...
      <button
        onClick={(e) => { e.stopPropagation(); onEditWithAI?.(); }}
        title="Edit with AI"
        style={btnStyle}
        onMouseEnter={(e) => { e.currentTarget.style.background = 'rgba(229,166,48,0.15)'; e.currentTarget.style.color = 'var(--primary)'; }}
        onMouseLeave={(e) => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = 'var(--muted-foreground)'; }}
      >
        <svg width="14" height="14" viewBox="0 0 16 16" fill="none">
          <path d="M8 2l1.5 3.5L13 7l-3.5 1.5L8 12 6.5 8.5 3 7l3.5-1.5L8 2z" stroke="currentColor" strokeWidth="1.2" strokeLinejoin="round" />
        </svg>
      </button>
      ...
      {expanded && onDelete && (
        <button
          ...
          onMouseEnter={(e) => { e.currentTarget.style.background = 'rgba(255,50,50,0.1)'; e.currentTarget.style.color = 'rgba(255,100,100,0.9)'; }}
