...
function EraserIcon() {
  return (
    <svg width={iconSize} height={iconSize} viewBox="0 0 16 16" fill="none">
      <path
        d="M10.5 2.5l3 3-7 7H3l-1-1 1.5-1.5 7-7z"
        stroke="currentColor"
        strokeWidth="1.2"
        strokeLinejoin="round"
        fill="none"
...
function MaximizeIcon() {
  return (
    <svg width={iconSize} height={iconSize} viewBox="0 0 16 16" fill="none">
      <path
        d="M3 6V3.5A0.5.5 0 013.5 3H6M10 3h2.5a0.5.5 0 01.5.5V6M13 10v2.5a0.5.5 0 01-.5.5H10M6 13H3.5a0.5.5 0 01-.5-.5V10"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
      />
...
function MinimizeIcon() {
  return (
    <svg width={iconSize} height={iconSize} viewBox="0 0 16 16" fill="none">
      <path
        d="M6 3v2.5a0.5.5 0 01-.5.5H3M10 3v2.5a0.5.5 0 00.5.5H13M10 13v-2.5a0.5.5 0 01.5-.5H13M6 13v-2.5a0.5.5 0 00-.5-.5H3"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
      />
