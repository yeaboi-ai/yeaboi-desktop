...
export const SLASH_COMMANDS: SlashCommand[] = [
  // Planning & Facilitator
  {
    ...
    args: 'engineer | pm | architect | mentor | challenger',
    category: 'Facilitator',
  },
  {
    name: 'assertiveness',
    description: 'Adjust AI energy',
    args: 'passive | balanced | active',
    category: 'Facilitator',
  },
  { name: 'summarize', description: 'Summarize discussion so far', category: 'Facilitator' },
  {
    name: 'focus',
    description: 'Focus on a blueprint topic',
    args: 'overview | goals | users | architecture | tech | api | ui | security | infrastructure | questions',
    category: 'Facilitator',
  },
  ...
  { name: 'blueprint', description: 'Show blueprint fill status', category: 'Blueprint' },
  {
    ...
    args: 'architecture | flow | erd | wireframe',
    category: 'Blueprint',
  },
  ...
  {
    name: 'wireframe',
    description: 'Generate wireframe layout',
    args: 'description',
    category: 'Design',
  },
  ...
  {
    name: 'dig',
    description: 'Ask the voice agent to go deeper on the recent topic',
    category: 'Call',
  },
