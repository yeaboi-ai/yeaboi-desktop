// When each Agents kind last saved a report — the stamps the home's two
// columns and the Sessions page show beside the four kinds, machine-wide or
// scoped to an engine project. A kind with no report, or a sidecar without
